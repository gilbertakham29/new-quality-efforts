<template>
 ...
 <div class="max-w-sm bg-[#253052] border border-[#000837] rounded-lg shadow">
     <a href="#">
         <NuxtImg class="max-w-full rounded-lg px-3 py-3" src="/office-laptops.png" alt="office-laptops-working" />
     </a>
     ...
     <div class="px-3">
         ...
         <div class="flex items-center space-x-4 mt-2 mb-10">
                    <div class="flex-shrink-0 mt-5">
                        <NuxtImg class="w-8 h-8 rounded-full" src="/jese.png" alt="Neil-person-image"/>
                    </div>
 ...
 <div class="max-w-sm bg-[#253052] border border-[#000837] rounded-lg shadow ">
    ...
    <a href="#">
     ...
     <div class="px-3">
         ...
         <div class="flex items-center space-x-4 mt-2 mb-10">
                    <div class="flex-shrink-0 mt-5">
                        <NuxtImg class="w-8 h-8 rounded-full" src="/roberta.png" alt="Roberta-person-image"/>
                    </div>
                    <div class="flex-1 min-w-0 mt-5">
                        <p class="text-sm font-medium text-white truncate dark:text-white">
                           Roberta Casas
