<template>
    <div class="bg-[#000837] max-w-screen py-5">
        <div class="flex items-center justify-center mb-5 md:mb-0">
            <NuxtImg width="64" class="md:w-32 w-16" src="/logoOne.svg" alt="qualityefforts-logo"/>
        ...
        <section class="col-span-4">
            <NuxtImg src="/table-rest.svg" width="100%" class="w-full" alt="human-working"/>
        </section>
        <section class="col-span-4">
            <div class="flex flex-col justify-center">
                <NuxtImg src="/arrow.webp" width="100%" class="w-full md:mt-5" alt="direction"/>
        ...
        <section class="col-span-4">
            <NuxtImg src="/robot.svg" width="100%" class="w-full" alt="AI-automation"/>
        </section>
    </div>
    ...
    <div class="flex md:flex-row flex-col w-11/12 mx-auto items-center mt-5 py-5 gap-5">
        ...
        <div class="mb-10 ml-5">
            <NuxtImg width="192" class="md:w-76 w-48 mb-1" src="/stars.webp" alt="five-star-rating"/>
